...
- **Message font size** — type any px value (10–32); applies to message text, headings, tables and code.
- **Table style** — choose `Default` or the Claude Desktop look (light-gray rounded cell cards with gaps, no borders).
- **Dialog width** — type any px (600–1600); the message column, composer input and the stats line widen together.
