...
export const BING_MARKET_OPTIONS = ['zh-CN', 'zh-HK', 'zh-TW', 'ja-JP', 'en-US', 'en-GB'];
/** The timeline defaults to DSH's native turn rail — the stock behavior. */
export const DEFAULT_TIMELINE_STYLE = 'native';
...
export const Config = z.object({
    ...
    timelineStyle: z.union(['native', 'web']).default(DEFAULT_TIMELINE_STYLE),
    themeStyle: z.union(['default', 'neon-lime']).default(DEFAULT_THEME_STYLE),
    searchEnabled: z.boolean().default(DEFAULT_SEARCH_ENABLED),
    searchEngine: z.union(['bing', 'ddg', 'exa', 'tavily', 'keenable', 'perplexity', 'deepseek']).default(DEFAULT_SEARCH_ENGINE),
