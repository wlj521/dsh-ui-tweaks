...
import { UI_TWEAKS_SETTINGS_NAMESPACE } from "./config.js";
...
export class UITweaksWebBackend {
    ...
    descriptor() {
        ...
        if (row === undefined)
            throw new Error('ui-tweaks settings namespace is not registered');
        return row;
    }
    snapshot() {
 ...
 */
export function installUITweaksWeb(ctx, backend) {
